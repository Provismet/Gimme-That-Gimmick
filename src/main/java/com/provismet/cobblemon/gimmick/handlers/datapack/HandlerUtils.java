        ...
        if (context.getWorld() instanceof ServerWorld serverWorld) {
            ...
            if (soundEvent == null) {
                if (apply && !effects.sound_apply().isEmpty()) {
                    GimmeThatGimmickMain.LOGGER.error("A: Invalid Sound used for pokemon: {}, sound id: {}",
                            ((PokemonEntity) context).getPokemon().getSpecies().getName(),
                            effects.sound_apply());
                } else if (!apply && !effects.sound_revert().isEmpty()) {
                    GimmeThatGimmickMain.LOGGER.error("R: Invalid Sound used for pokemon: {}, sound id: {}",
                            ((PokemonEntity) context).getPokemon().getSpecies().getName(),
            ...
            if (particleType instanceof ParticleEffect particle) {
                ...
                if (apply && !effects.particle_apply().isEmpty()) {
                    GimmeThatGimmickMain.LOGGER.error("A: Invalid Particle used for pokemon: {}, sound id: {}",
                            ((PokemonEntity) context).getPokemon().getSpecies().getName(),
                            effects.particle_apply());
                } else if (!apply && !effects.particle_revert().isEmpty()) {
                    GimmeThatGimmickMain.LOGGER.error("R: Invalid Particle used for pokemon: {}, sound id: {}",
                            ((PokemonEntity) context).getPokemon().getSpecies().getName(),
