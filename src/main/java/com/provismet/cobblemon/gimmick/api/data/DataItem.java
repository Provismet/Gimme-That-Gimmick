 ...
 */
public record DataItem(String name, List<String> tooltip, Identifier baseItem, Integer customModelData,
                       Rarity rarity) implements DataItemStack {
    ...
    public ItemStack create() {
        ...
        if (item.isPresent()) {
            ...
            if (this.customModelData != null)
                stack.set(DataComponentTypes.CUSTOM_MODEL_DATA, new CustomModelDataComponent(this.customModelData));
