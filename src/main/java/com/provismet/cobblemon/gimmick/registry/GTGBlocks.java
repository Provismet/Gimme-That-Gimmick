...
public abstract class GTGBlocks {
    public static final Block POWER_SPOT = register("power_spot", BlockModelType.FULL_BLOCK, AbstractBlock.Settings.create().solid().mapColor(MapColor.DULL_RED), GenericPolymerTexturedBlock::new);
    public static final Block METEORITE = register("meteorite", AbstractBlock.Settings.create().solid().mapColor(MapColor.GRAY), MeteoriteBlock::new);
    ...
    private static Block register (String name, AbstractBlock.Settings settings, BiFunction<AbstractBlock.Settings, Identifier, GenericPolymerTexturedBlock> constructor) {
        Identifier id = GimmeThatGimmickMain.identifier(name);
